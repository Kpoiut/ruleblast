...
This tree is RuleBlast `v2.4.3`. Latest independently verified public npm release is `v2.4.1`. Fastest contribution: [surprising result](https://github.com/Kpoiut/ruleblast/issues/new?template=surprising-result.yml) — command, observed text, one sentence. No canonical JSON. Promoted Blast Cases stay the evidence gate.
