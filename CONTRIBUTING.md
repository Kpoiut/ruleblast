...
RuleBlast `v1.0.2` is the latest verified public release. This tree is `1.1.0`. Fastest contribution: [surprising result](https://github.com/Kpoiut/ruleblast/issues/new?template=surprising-result.yml).
