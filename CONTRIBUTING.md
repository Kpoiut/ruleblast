...
This tree is RuleBlast `2.0.0`. Latest independently verified public npm release is `v1.6.2`. Fastest contribution: [surprising result](https://github.com/Kpoiut/ruleblast/issues/new?template=surprising-result.yml) — command, observed text, one sentence. No canonical JSON. Promoted Blast Cases stay the evidence gate.
