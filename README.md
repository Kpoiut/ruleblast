...
<p align="center">
  <img src="assets/ruleblast-hero.png?v=2.1.0" alt="RuleBlast — See the second diff. Local, read-only, evidence-first" width="100%">
</p>
...
<p align="center">
  ...
  <a href="https://github.com/Kpoiut/ruleblast/releases/tag/v2.1.0"><img src="https://img.shields.io/github/package-json/v/Kpoiut/ruleblast" alt="package version 2.1.0"></a>
...
<div align="center">
  <img src="assets/ruleblast-causal-proof.gif?v=2.1.0" alt="Terminal demo: git sees 3 files and 6 deletions; ruleblast diff shows Codex 206 paths and Claude Code 0; explain names nested AGENTS.md" width="100%">
</div>
...
<div align="center">
  <img src="assets/ruleblast-visual-benchmark.png?v=2.1.0" alt="Square RuleBlast 2.1.0 scoreboard: Git saw 2 instruction lines; Codex 206, Claude Code 0; why-this-path, CLI and IDE surfaces, user allow gate" width="100%">
</div>
...
Published CLI is `ruleblast@2.1.0`. Node.js 20+. `npx` downloads and runs the pinned package.
...
npx --yes ruleblast@2.1.0 case --explain .github/ISSUE_TEMPLATE/missing-blast.yml
```
...
```bash
npx --yes ruleblast@2.1.0 .
npx --yes ruleblast@2.1.0 packages/api/internal
npx --yes ruleblast@2.1.0 diff HEAD~1
npx --yes ruleblast@2.1.0 explain src/args.ts --from HEAD~1
npx --yes ruleblast@2.1.0 diff HEAD~1 --json
```
...
npx --yes ruleblast@2.1.0 . --receipt
```
