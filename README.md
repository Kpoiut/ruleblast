...
<p align="center">
  <img src="assets/ruleblast-hero.png?v=2.4.7" alt="RuleBlast — See the second diff. Local, read-only, evidence-first" width="100%">
</p>
...
<p align="center">
  ...
  <a href="https://github.com/Kpoiut/ruleblast/releases/tag/v2.4.6"><img src="https://img.shields.io/github/package-json/v/Kpoiut/ruleblast" alt="this tree 2.4.7"></a>
...
<div align="center">
  <img src="assets/ruleblast-causal-proof.gif?v=2.4.7" alt="Terminal demo: git sees 3 files and 6 deletions; ruleblast diff shows Codex 206 paths and Claude Code 0; explain names nested AGENTS.md" width="100%">
</div>
...
<p align="center"><sub>This tree is 2.4.7. Published CLI is ruleblast@2.4.6. Local · read-only · deterministic · no network or model call</sub></p>
...
<div align="center">
  <img src="assets/ruleblast-visual-benchmark.png?v=2.4.7" alt="Square RuleBlast 2.4.6 scoreboard: Git saw 2 instruction lines; Codex 206, Claude Code 0; why-this-path, CLI and IDE surfaces, user allow gate" width="100%">
</div>
