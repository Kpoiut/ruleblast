...
<p align="center">
  <img src="assets/ruleblast-hero.png?v=1.6.1" alt="RuleBlast — See the second diff. Local, read-only, evidence-first" width="100%">
</p>
...
<p align="center">
  ...
  <a href="https://github.com/Kpoiut/ruleblast/releases/tag/v1.6.1"><img src="https://img.shields.io/github/package-json/v/Kpoiut/ruleblast" alt="package version 1.6.1"></a>
...
<div align="center">
  <img src="assets/ruleblast-causal-proof.gif?v=1.6.1" alt="Terminal demo: git sees 3 files and 6 deletions; ruleblast diff shows Codex 206 paths and Claude Code 0; explain names nested AGENTS.md" width="100%">
</div>
...
<div align="center">
  <img src="assets/ruleblast-visual-benchmark.png?v=1.6.1" alt="What Git missed: 2 instruction lines, 206 Codex paths, 0 Claude Code paths" width="100%">
</div>
...
Published CLI is `ruleblast@1.6.1`. Node.js 20+. `npx` downloads and runs the pinned package.
...
npx --yes ruleblast@1.6.1 case --explain .github/ISSUE_TEMPLATE/missing-blast.yml
```
...
```bash
npx --yes ruleblast@1.6.1 .
npx --yes ruleblast@1.6.1 packages/api/internal
npx --yes ruleblast@1.6.1 diff HEAD~1
npx --yes ruleblast@1.6.1 explain src/args.ts --from HEAD~1
npx --yes ruleblast@1.6.1 diff HEAD~1 --json
```
...
npx --yes ruleblast@1.6.1 . --receipt
```
