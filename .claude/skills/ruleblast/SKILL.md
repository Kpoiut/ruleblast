...
| Symptom | Command |
|---|---|
| What does each pinned CLI project now? | `npx --yes ruleblast@2.0.1 . --color=never` |
| Which stacks moved? | `npx --yes ruleblast@2.0.1 diff HEAD~1 --to HEAD --color=never` |
| Why this path? | `npx --yes ruleblast@2.0.1 explain <path> --from HEAD~1 --to HEAD --json` |
| Teaching receipt, no clone | `npx --yes ruleblast@2.0.1 case --color=never` |
