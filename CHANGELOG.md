...
- README causal-proof GIF types the everyday CLI: `git diff --stat HEAD~1`, `ruleblast diff HEAD~1`, `ruleblast explain <path> --from HEAD~1`. No npx pin and no commit hashes in the typed commands. Sealed 2→206 output is unchanged.
