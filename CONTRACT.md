...
The v1 package version is `1.4.4`. An authorized distribution binds it to signed source tag `v1.4.4`; registry and GitHub Release availability are external facts that this contract never infers from a source checkout. Latest independently verified public npm distribution remains `1.3.0`.
