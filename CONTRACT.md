...
The v1 package version is `1.0.2`. An authorized distribution binds it to signed source tag `v1.0.2`; registry and GitHub Release availability are external facts that this contract never infers from a source checkout.
