...
CORE
  ...
  diff       ${ROUTES[1]!.useWhen}
             ...
             CHANGE ALIGNMENT, INTENT, and a WORK MAP. --json stays canonical.
...
Usage:
  ruleblast [path] [--json] [--paths-only] [--index] [--detail] [--witness] [--receipt] [--reality <id>]... [--color=auto|always|never]
  ruleblast diff [base] [--to <ref|WORKTREE>] [--json] [--paths-only] [--index] [--detail] [--witness] [--receipt] [--reality <id>]... [--color=auto|always|never]
  ruleblast explain <path> [--from <ref>] [--to <ref|WORKTREE>] [--json] [--compare] [--detail] [--witness] [--receipt] [--reality <id>]... [--color=auto|always|never]
  ruleblast case [--explain <path>] [--json] [--paths-only] [--index] [--detail] [--witness] [--receipt] [--color=auto|always|never]
  ruleblast --mcp
  ruleblast --help
  ruleblast --version
`;
